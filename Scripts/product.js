...
function videolink(){
    if (localStorage.getItem("product image")=="5"){
        ...
        window.location.href = "https://sketchfab.com/3d-models/shellring-high-cbf3bdfcd90e4687b024a20472c67233";
    } else {
...
if (localStorage.getItem("product image") == "1"){
    ...
    document.getElementById("product_image3").src = "Pictures/yuseong_3df.png";
    ...
    document.getElementById("product_image3").style.cursor = "pointer";
    document.getElementById("product_image3").src = "Pictures/shannon_3df.png";
